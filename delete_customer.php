...
<body>
    ...
    <div class ="delete_customer_container" style="background-color: #94B49F; color: black; border: none; border-radius: 10px;">
    <div class ="delete_customer_container_heading">
    <h3>Delete Customer</h3>
    </div>
        <form method="POST">
            <input type="text" style="outline: none; border: none; border-radius: 5px;" name="Cust_ac_no" placeholder="Customer A/c No." required><br>
            <input type="text" style="outline: none; border: none; border-radius: 5px;" name="Cust_ac_Id" placeholder="Customer ID" required ><br>
            <input type="text" style="outline: none; border: none; border-radius: 5px;" name="reason" placeholder="Reason" required><br>
            <input type="submit" style="background-color: #CEE5D0; border: none; border-radius: 5px; width: 20%; color: black; font-weight: bold; box-shadow: 1px 1px 5px black;" name="delete" value="Delete">
            </form>
        </div>

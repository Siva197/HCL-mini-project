...
<body>
    ...
    <div class="fundtransfer_conainer" style="background-color: #CEE5D0; color: black;">
        ...
        <div class="fund_transfer">
			<div class="beneficiary_btn">
				<form id="form1" method="post">
					<a href="add_beneficiary.php"><input class="beneficiary" type="submit" style="background-color: #94B49F; border: none; border-radius: 5px;" name="add_beneficiary" value="Add beneficiary"></a>
			</div>
	</form>
					<br>
		...
		<?php } ?>
				...
				<input type="submit" name="fnd_trns_btn" style="background-color: #94B49F; border: none; border-radius: 5px; box-shadow: 1px 1px 5px black;" value="Send"><br>
		</div>
		</form>

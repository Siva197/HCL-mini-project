...
?>
    <div class="add_beneficiary_container" style="background-color: #CEE5D0; color: black;">
        <form method="post">
            ...
            <input type="submit" style="background-color: #94B49F; border: none; box-shadow: 1px 1px 5px black; border-radius: 5px;" name="add_beneficiary_btn" value="Add"><br><br>

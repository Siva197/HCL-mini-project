...
?>
	...
	<div class="cust_myacc_container">
            ...
            <div class="accdet">
				...
				<a href="customer_pass_change.php"><input type="button" name="pass-chng" style="color: black; background-color: #94B49F; color: white; border: none; border-radius: 5px;" value="Change Password"></a>
            </div>

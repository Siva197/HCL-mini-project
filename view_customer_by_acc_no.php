...
<body>
    ...
    <div class="view_cust_byac_container_outer" style="background-color: #94B49F; border: none;
    border-radius: 10px;">
    <form method="POST">
        <input name="account_no" style="border: none; border-radius: 10px; outline: none;" placeholder="Customer Account No"><br>
        <input type="submit" name="submit_view" style="width: 30%; border-radius: 10px; border: none; box-shadow: 1px 1px 5px black; background-color: #CEE5D0; cursor: pointer; color: black; font-weight: bold;" value="Search">
    </form>
    </div>
    <?php 

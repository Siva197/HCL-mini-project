...
<div class="debit_card_form_container" style="background-color: #CEE5D0; border: none; border-radius: 5px;">
    <br>
<form method="POST">
    <i class="fa-regular fa-credit-card" style="margin-left: 44%; margin-bottom: 2%;     font-size: 50; "></i>
<input type="text" style="border: none; border-radius: 10px; outline: none;  " name="holder_name" placeholder="Account Holder Name"><br>
<input type="text" name="dob" placeholder="Date of Birth" style="border: none; border-radius: 10px; outline: none; " onfocus="(this.type='date')"><br>
<input type="text" style="border: none; border-radius: 10px; outline: none; " name="pan" placeholder="PAN"><br>
<input type="text" style="border: none; border-radius: 10px; outline: none; " name="mob" placeholder="Registered Mobile (10 Digit)"><br>
<input type="text" style="border: none; border-radius: 10px; outline: none; " name="acc_no" placeholder="Account No"><br>
<input type="submit" style="border: none; border-radius: 10px; outline: none; width: 20%; background-color: #94B49F; color: black; box-shadow: 1px 1px 5px black ; font-weight: bold; " name ="dbt_crd_submit" value="Submit" ><br>
<form>
</div>
</body>

...
?>
        ...
        <div class="cust_statement_container_head">
         ...
         <div class="cust_statement">
                ...
                <table>
                <th style="background-color: #94B49F;">S.no</th>
                <th style="background-color: #94B49F;">Date</th>
                <th style="background-color: #94B49F;">Transaction Id</th>
                <th style="background-color: #94B49F;">Description</th>
                <th style="background-color: #94B49F;">Cr</th>
                <th style="background-color: #94B49F;">Dr</th>
                <th style="background-color: #94B49F;">Balance</th>
                <?php

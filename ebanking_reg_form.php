...
<head>
    ...
    <body>
       ...
       <h3 style="background-color:#CEE5D0; border: none; border-radius: 5px; color: black;">Internet Banking Registration</h3>
        <div class="ebanking_reg_form_container_child" style="background-color: #94B49F; border: none; border-radius: 10px; ">
        <form method="post">
            <input type="text" style="outline: none; border: none; border-radius: 5px;" name="holder_name" placeholder="Account Holder Name *" required/>
            <input type="text" style="outline: none; border: none; border-radius: 5px;" name="accnum" placeholder="Account Number*" required />
            <input type="text" style="outline: none; border: none; border-radius: 5px;" name="dbtcard" placeholder="Debit Card Number*" required />
            <input type="text" style="outline: none; border: none; border-radius: 5px;" name="dbtpin" placeholder="Debit Card Pin*" required/>   
            <input type="text" style="outline: none; border: none; border-radius: 5px;" name="mobile" placeholder="Registered Mobile*" required />
            <input type="text" style="outline: none; border: none; border-radius: 5px;" name="pan_no" placeholder="PAN Number*" required />
            <input type="text" style="outline: none; border: none; border-radius: 5px;" name="dob" placeholder="Date of Birth*" onfocus="(this.type='date')" required />
            <input type="text" name="last_trans" placeholder="Last Transaction*"required />
            <input type="password" style="outline: none; border: none; border-radius: 5px;" name="password" placeholder="Password*" minlength=7 required/>
            <input type="password" style="outline: none; border: none; border-radius: 5px;" name="cnfrm_password" placeholder="Confirm Password*" required/>
            <input type="submit" style="cursor:pointer; background-color: #CEE5D0; color: black;
            border: none; border-radius: 5px; box-shadow: 1px 1px 5px black;" name="submit" value="Submit"/>
            </form>
            </div>
    </div>
